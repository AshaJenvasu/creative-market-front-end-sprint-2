        ...
        <div className="flex flex-col md:flex-row gap-8 w-full cursor-pointer h-87.5">
              ...
              <div className="absolute bottom-0 left-0 w-full bg-white/90 backdrop-blur-md p-6 md:p-8 flex flex-col gap-1 border-t border-gray-100">
                <div className="flex justify-between items-baseline">
                  ...
                  <p className="text-sm md:text-lg text-gray-600">
                    by{" "}
                    <span className="font-bold text-gray-900">Name Artist</span>
                  </p>
                </div>
          ...
          <div className="hidden md:flex md:w-1/2 h-full flex-col justify-center text-white group">
            <div className="flex flex-col">
              <div className="mb-6 md:mb-10 self-end">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
              ...
              <h2 className="text-8xl font-bold tracking-tighter leading-[0.9] uppercase text-left">
                <span className="relative inline-block">
                  <span className="absolute -inset-2 bg-[#6D5DD3] -z-10 opacity-80 translate-x-[-10%] translate-y-[10%] w-[90%] h-[90%]"></span>
                  E
                </span>
                XPLORING
                <br />
